...
function _G.show_docs()
    ...
    elseif vim.fn.CocActionAsync('doHover') then
        -- Changed the condition to use CocActionAsync
    else
...
-- Do the default action for the next item
keyset("n", "<space>j", ":<C-u>CocNext<cr>", list_opts)
-- Do the default action for the previous item
